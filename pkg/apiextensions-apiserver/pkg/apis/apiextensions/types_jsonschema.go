...
type JSONSchemaProps struct {
	...
	// x-doc-default is field with default value for documentation.
	// +optional
	XDocDefault *JSON `json:"x-doc-default,omitempty" protobuf:"bytes,45,opt,name=xKubernetesDocDefault"`

	// x-doc-example is field with example string for documentation.
	// +optional
	XDocExample *JSON `json:"x-doc-example,omitempty" protobuf:"bytes,46,opt,name=xKubernetesDocExample"`
}
